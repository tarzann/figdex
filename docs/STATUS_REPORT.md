...
**תאריך:** 31 בינואר 2026 (עדכון: 8 בפברואר 2026)  
**גרסה:** v1.30.77 (פלאגין) / v1.30.40 (ווב)  
...
|------|-------------|--------|
| `plugin/code.js` | **1.30.77** | קוד ריצה (sandbox), בניית אינדקס, העלאה |
| `plugin/ui.html` | 1.30.77 | ממשק משתמש, לוגין, העלאה |
