        ...
        <Box sx={{ display: 'grid', gridTemplateColumns: { xs: '1fr', md: 'repeat(3, 1fr)' }, gap: 4 }}>
          {[
            { 
              name: 'Free', 
              price: '$0', 
              desc: 'For individual designers getting started.',
              features: ['1 project', '500 frames', 'Basic search']
            },
            { 
              name: 'Pro', 
              price: '$15', 
              desc: 'For teams who need automation, custom tags, and advanced filters.',
              features: ['5 projects', '50K frames', 'API access', 'Custom tags'],
              highlight: true
            },
            { 
              name: 'Enterprise', 
              price: 'Custom', 
              desc: 'Unlimited projects, collaboration, analytics, and support.',
              features: ['Unlimited', 'Team features', 'Analytics', 'Priority support']
            },
          ].map((plan, idx) => (
            <Box key={idx}>
              <Card 
